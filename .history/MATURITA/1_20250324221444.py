...
if threes == 0:
    ...
    canvas.create_rectangle(125,500 - 47*threes,145,470)

if fours == 0:
    None
else:
    canvas.create_rectangle(170,500 - 47*fours,190,470)

if fives == 0:
    None
else:
    canvas.create_rectangle(215,500 - 47*fives,235,470)


if sixs == 0:
    None
else:
    canvas.create_rectangle(260,500 - 47*sixs,280,470)
