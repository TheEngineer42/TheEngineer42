...
b_empty = Button(frame2, height = 5, width = 9, text = ' ')
b_zero = Button(frame2, height = 5, width = 9, text = '0')
b_equals = Button(frame2, height = 5, width = 9, text = '=')
b_divide = Button(frame2, height = 5, width = 9, text = '/')
